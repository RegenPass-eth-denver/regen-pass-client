      ...
      <section className="container mx-auto px-6 py-16 md:py-24 relative">
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-purple-900/40 to-pink-900/40 p-8 md:p-10 rounded-3xl backdrop-blur-md border border-white/10 shadow-xl shadow-purple-500/5">
          <p className="text-lg md:text-xl text-black leading-relaxed">
            Designed for the Eth Denver community, RegenPass combines
            cutting-edge technologies—geo-fencing, augmented reality, artificial
            intelligence, and blockchain—with eco-conscious values to deliver a
            dynamic Proof of Attendance Protocol (POAP) experience. Whether
            you're exploring interactive event zones or earning exclusive
            on-chain rewards, RegenPass redefines how you engage with events.
          </p>
        </div>
      </section>

      {/* Features Section */}
      <section id="features" className="container mx-auto px-6 py-16  relative">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 p-8 rounded-3xl backdrop-blur-md border border-white/10 shadow-xl shadow-purple-500/5 hover:shadow-purple-500/10 hover:border-white/20 transition-all duration-300 group">
            ...
            <ul className="space-y-4 ml-4">
              <li className="flex items-start">
                ...
                <span>
                  <strong className="text-black">Effortless Sign-Up:</strong>{" "}
                  <span className="text-black">
                    Register quickly using your favorite social media platforms.
                  </span>
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span>
                  ...
                  <span className="text-black">
                    Get an on-chain wallet set up instantly to store your unique
          ...
          <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 p-8 rounded-3xl backdrop-blur-md border border-white/10 shadow-xl shadow-purple-500/5 hover:shadow-purple-500/10 hover:border-white/20 transition-all duration-300 group">
            ...
            <ul className="space-y-4 ml-4">
              <li className="flex items-start">
                <span className="text-purple-400 mr-3 text-xl">•</span>
                <span>
                  <strong className="text-black">Smart GPS Navigation:</strong>{" "}
                  <span className="text-black">
                    Use geo-fencing to guide you to designated event zones,
                    ensuring you never miss a key interaction.
                  </span>
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-purple-400 mr-3 text-xl">•</span>
                <span>
                  <strong className="text-black">Immersive AR Triggers:</strong>{" "}
                  <span className="text-black">
                    Activate your camera to scan banners, logos, and other
                    visual cues, unlocking augmented reality experiences that
          ...
          <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 p-8 rounded-3xl backdrop-blur-md border border-white/10 shadow-xl shadow-purple-500/5 hover:shadow-purple-500/10 hover:border-white/20 transition-all duration-300 group">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold">3. AI-Powered Engagement</h3>
            </div>
            <ul className="space-y-4 ml-4">
              <li className="flex items-start">
                <span className="text-purple-400 mr-3 text-xl">•</span>
                <span>
                  <strong className="text-black">Interactive AI Agents:</strong>{" "}
                  <span className="text-black">
                    Receive personalized recommendations and real-time
                    assistance from intelligent AI agents, enhancing your
              ...
              <li className="flex items-start">
                ...
                <span>
                  ...
                  <span className="text-black">
                    Leverage AI to instantly recognize and process
                    event-specific triggers, ensuring you capture every moment
                    and reward.
                  </span>
                </span>
              </li>
          ...
          <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 p-8 rounded-3xl backdrop-blur-md border border-white/10 shadow-xl shadow-purple-500/5 hover:shadow-purple-500/10 hover:border-white/20 transition-all duration-300 group">
            ...
            <ul className="space-y-4 ml-4">
              <li className="flex items-start">
                <span className="text-purple-400 mr-3 text-xl">•</span>
                <span>
                  <strong className="text-black">Dynamic POAP Assets:</strong>{" "}
                  <span className="text-black">
                    Earn exclusive digital mementos that serve as verifiable
              ...
              <li className="flex items-start">
                ...
                <span>
                  ...
                  <span className="text-black">
                    Unlock special discounts, early access, and exclusive
                    benefits.
                  </span>
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-purple-400 mr-3 text-xl">•</span>
                <span>
                  <strong className="text-black">Unique NFTs:</strong>{" "}
                  <span className="text-black">
                    Collect one-of-a-kind digital assets that commemorate your
                    experience.
                  </span>
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-purple-400 mr-3 text-xl">•</span>
                <span>
                  <strong className="text-black">Cross-Chain Minting:</strong>{" "}
                  <span className="text-black">
                    Seamlessly mint and transfer your rewards across multiple
                    blockchain networks with CCIP & Chainlink Functions.
                  </span>
                </span>
              </li>
            </ul>
            ...
            <ul className="space-y-4 ml-4">
              <li className="flex items-start">
                ...
                <span>
                  ...
                  <span className="text-black">
                    Utilize Chainlink's Verifiable Random Function (VRF) to
                    guarantee that all random reward distributions are secure,
            ...
            <ul className="space-y-4 ml-4">
              <li className="flex items-start">
                ...
                <span>
                  ...
                  <span className="text-black">
                    Track your performance and compare with fellow participants,
                    fostering a sense of community and healthy competition.
                  </span>
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span>
                  ...
                  <span className="text-black">
                    Participate in event challenges and referrals that enhance
                    the social aspect of RegenPass, driving further engagement
      ...
      <section className="container mx-auto px-6 py-16 md:py-24 relative">
        <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-purple-900/40 to-pink-900/40 p-10 md:p-16 rounded-3xl backdrop-blur-md border border-white/10 shadow-xl shadow-purple-500/5 overflow-hidden relative">
          ...
          <p className="text-lg md:text-xl mb-10 text-black max-w-2xl mx-auto">
            Join RegenPass today and discover a new way to engage with events,
            earn rewards, and connect with the community.
          </p>
          <button
      ...
      <footer className="bg-[#0c162c] backdrop-blur-sm py-16 border-t border-white/10">
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-white/10 mt-12 pt-8 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} RegenPass. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
