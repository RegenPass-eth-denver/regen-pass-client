...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent bg-white/95 dark:bg-[#1a1a1a]/95 backdrop-blur-sm border-gray-200 dark:border-gray-800 shadow-xl flex items-center justify-between px-4 sm:px-8 py-4 font-montserrat animate-glow-pulse mx-4 sm:mx-0"
    >
...
function Navbar({ className }: { className?: string }) {
  ...
  return (
    <div className={cn("fixed top-6 sm:top-8 md:top-10 inset-x-0 max-w-[95%] sm:max-w-4xl mx-auto z-[100]", className)}>
      <Menu setActive={setActive}>
        <div className="relative">
          <button className="inline-flex h-10 sm:h-12 animate-shimmer items-center justify-center rounded-full border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] px-6 sm:px-8 text-sm sm:text-base font-medium text-slate-300 transition-all duration-300 hover:scale-105 hover:text-white focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            Get Started
